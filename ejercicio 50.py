#Escribe un algoritmo o el respectivo diagrama de flujo para leer una cantidad variable de números e 
# indicar el promedio de los números pares y el promedio de los números impares.
...
for i in range ( n ):
        ...
        if  num % 2 == 0 :
            numerospares . añadir ( num )
        else:
            numerosimpares . añadir ( num )
